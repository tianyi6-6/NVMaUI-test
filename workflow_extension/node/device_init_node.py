...
def register_device_init_nodes(registry: NodeRegistry):
    ...
    memory_params = [
        _make_param("设备内存", "IIR系数", "float", "1.0V", "0.0-100.0", minimum=0, maximum=100, step=0.1, unit="V"),
        _make_param("设备内存", "DAQ系数", "float", "1.0V", "0.0-100.0", minimum=0, maximum=100, step=0.1, unit="V"),
        _make_param("设备内存", "直流DAQ系数", "float", "1.0V", "0.0-100.0", minimum=0, maximum=100, step=0.1, unit="V"),
        _make_param("设备内存", "通道1-IIR电压转磁场系数", "float", "2.100754e-06T/V", "0-1e20", minimum=0, maximum=1e-5, step=1e-8, unit="T/V"),
        _make_param("设备内存", "通道2-IIR电压转磁场系数", "float", "2.100754e-06T/V", "0-1e20", minimum=0, maximum=1e-5, step=1e-8, unit="T/V"),
        _make_param("设备内存", "双微波模式IIR电压转磁场系数", "float", "2.100754e-06T/V", "0-1e20", minimum=0, maximum=1e-5, step=1e-8, unit="T/V"),
        _make_param("设备内存", "微波通道1一阶微分谱零点位置", "float", "2899011184.6533003Hz", "2600000000-3100000000", minimum=2600000000, maximum=3100000000, step=1, unit="Hz"),
        _make_param("设备内存", "微波通道2一阶微分谱零点位置", "float", "2899421000.0Hz", "2600000000-3100000000", minimum=2600000000, maximum=3100000000, step=1, unit="Hz"),
        _make_param("设备内存", "等效旋磁比", "float", "3.5495e13Hz/T", "0-1e16", minimum=1e10, maximum=1e16, step=1e10, unit="Hz/T"),
        _make_param("设备内存", "微波通道1一阶微分谱斜率", "float", "3.437e-08V/Hz", "-1-1", minimum=-1, maximum=1, step=1e-9, unit="V/Hz"),
        _make_param("设备内存", "微波通道2一阶微分谱斜率", "float", "3.437e-08V/Hz", "-1-1", minimum=-1, maximum=1, step=1e-9, unit="V/Hz"),
        _make_param("设备内存", "直流DAQ采样率", "int", "125Hz", "125-125", minimum=125, maximum=125, step=1, unit="Hz"),
        _make_param("设备内存", "DAQ运算抽取率", "int", "2499", "0-25000000", minimum=0, maximum=25000000, step=1),
        _make_param("设备内存", "DAQ数据采集时间", "float", "1.0s", "0-1000", minimum=0, maximum=1000, step=0.1, unit="s"),
        _make_param("设备内存", "IIR数据采集时间", "float", "1.0s", "0-1000", minimum=0, maximum=1000, step=0.1, unit="s"),
        _make_param("设备内存", "微波调制深度系数", "float", "0.5MHz", "0.0-100", minimum=0, maximum=100, step=0.1, unit="MHz"),
        _make_param("设备内存", "超声电机转速", "int", "100°/s", "50-240", minimum=50, maximum=240, step=1, unit="°/s"),
        _make_param("设备内存", "超声电机转动方向", "select", "2", "0-2", options=["0", "1", "2"]),
