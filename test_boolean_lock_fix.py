                ...
                def test_default_route():
                    try:
                        ...
                        if len(waypoint_table.waypoints) > 0:
                            ...
                            # 测试布尔锁变量状态
                            print(f"✓ 更新锁状态: {waypoint_table._updating_table}")
...
def test_boolean_lock_mechanism():
    """测试布尔锁机制"""
    print("\n=== 测试布尔锁机制 ===")
...
if __name__ == '__main__':
    ...
    # 测试布尔锁机制
    if test_boolean_lock_mechanism():
        # 测试完整程序
        result = test_boolean_lock_fix()
        sys.exit(result)
    else:
        sys.exit(1) 